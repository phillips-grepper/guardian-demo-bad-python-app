...
2. A JSON API endpoint at POST /users to create users (accepts Full name + email + title + Birthdate + Address + City + State + Zipcode + body as JSON). The body field accepts HTML formatting. Return the created user as JSON
